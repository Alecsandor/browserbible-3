...
// 		Rev: 'RV'
	...
	var
		...
		totalNumberOfChapters = 26 ,  //modify this based on what it is in com-....txt (dacă în comentariu se face referire la 2 capitole atunci adăugăm 2)(ex: Matei=28 cap, Marcu=16 cap...)
		startBookIndex = 0,
		endBookIndex = Object.keys(bookMap).length,

		startChapterIndex = Object.keys(bookMap).length,
		endChapterIndex = startChapterIndex + totalNumberOfChapters,

		startVerseIndex = endChapterIndex,
